...
activities = {
    ...
    "Art Club": {
        ...
        "max_participants": 16,
        "participants": ["chloe@mergington.edu", "sara@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Debate Team": {
        "description": "Prepare arguments and compete in debate competitions",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["maria@mergington.edu", "zach@mergington.edu"]
    },
    "Robotics Club": {
